package org.szelc.tga.fxml.app;
 ...
 */
public class TgaFxml extends Application implements FitLoaderListener{
    Pane rootPane;
    private Stage stage;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            ...
            Logger.getLogger(TgaFxml.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private Initializable replaceSceneContent(String fxml) throws Exception {
        ...
        InputStream in = TgaFxml.class.getResourceAsStream(fxml);
        loader.setBuilderFactory(new JavaFXBuilderFactory());
        loader.setLocation(TgaFxml.class.getResource(fxml));
    ...
    public void addMapTab(){
       ...
       // Tab tabMap = new Tab();
        ...
        Tab tabMap = tabPane.getTabs().get(1);
    ...
    public void loaded(Training training) {
        ...
        //org.szelc.tga.fxml.training.displayWayPoint();
